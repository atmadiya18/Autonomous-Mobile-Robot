...
class Navigation:
    ...
    def rotation(self,p, origin=(0, 0), degrees=0):
    ...
    def a_star_path_planner(self):
        ...
        new_points_g = self.rotation([(0,index_y_g)], origin=origin, degrees=180)

        new_points_c = self.rotation([(0,index_y_c)], origin=origin, degrees=180)
    ...
    def converting_waypoints(self, path):
        ...
        for index in range(len(path)-1):
            ...
            new_points_g = self.rotation([(0,y1)], origin=origin, degrees=180)
            y1 = int(new_points_g[1])
            new_points_g = self.rotation([(0,y2)], origin=origin, degrees=180)
    ...
    def run(self):
        ...
        transformed_path = self.converting_waypoints(path)
